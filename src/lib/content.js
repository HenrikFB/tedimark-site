export const siteConfig = {
  ...
  description:
    "I transform businesses through technology, digitalization, and strategic marketing. From AI engineering to go-to-market — you review milestones, I handle the rest.",
...
export const services = [
  ...
  },
  {
    ...
    fullDesc:
      "I automate the repetitive. Data pipelines that run themselves, internal processes that never miss a step, and integrations that keep your tools in sync. Whether it's n8n workflows, custom scripts, or end-to-end process automation — I build systems that free your team to focus on what matters.",
  ...
  },
  {
    ...
    fullDesc:
      "Full-stack development with modern frameworks. I build responsive web applications, cross-platform mobile apps, and complex backend systems. Every project ships with tests, documentation, and a scalable architecture that grows with your business.",
  ...
  },
  {
    ...
    shortDesc:
      "Evaluation and integration of APIs, SDKs, and platforms. I find the right solution and build it in.",
    fullDesc:
      "Choosing the right third-party tools can make or break a project. I evaluate, compare, and integrate APIs, SDKs, and platforms so you don't have to. From payment processors to mapping services, I find the right fit and build it in properly.",
  ...
  },
  {
    ...
    fullDesc:
      "Speed to market matters. I take your idea from concept to launched product in weeks — with validation research, rapid prototyping, landing pages, and a go-to-market strategy. Test assumptions fast, iterate on real feedback, and launch with confidence.",
  ...
  },
  {
    ...
    fullDesc:
      "When your product lives in the physical world, I bridge the gap between hardware and software. Sensor integrations, microcontroller programming, cloud connectivity, and real-time data pipelines — I make your physical products smart.",
  ...
  },
  {
    ...
    fullDesc:
      "Enterprise-grade compliance isn't optional — it's foundational. I handle security audits, GDPR compliance, risk assessments, and governance frameworks so your technology meets the standards your industry demands.",
...
export const processSteps = [
  {
    ...
    title: "Discovery",
    description:
      "I dive into your problem, your users, and your market. You talk — I listen and investigate.",
    color: "#2563EB",
  },
  {
    number: "02",
