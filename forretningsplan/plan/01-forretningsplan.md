# Forretningsplan — TeDiMark

## 1. Positionering

**Nuværende site-positionering** (behold den): "You review. I handle the rest." — én teknisk partner fra idé til lancering.

**Skærpelse til salg og outreach** (det du siger/skriver, når du kontakter kunder):

> *"Jeg hjælper danske virksomheder med at slippe af med manuelt dokumentarbejde — fakturaer, bilag, kontrakter og formularer — ved at bygge AI-automatiseringer, der omdanner rodede filer til struktureret data i jeres systemer."*

Hjemmesidens 7 services forbliver bagkataloget (AI Engineering, Automation, Software Dev, Third-Party Tech, MVPs, Hardware & IoT, Compliance). Men i marketing og outreach fører du med ÉT tilbud. Bredde skaber tvivl; ét skarpt tilbud skaber svar.
...
**Sekundær** (senere): startups der skal have bygget MVP'er — det matcher din MVP-service, men salget er sværere at systematisere, så det er opportunistisk, ikke fokus.

## 3. Værditilbud

Kundens regnestykke skal altid være synligt:

- Medarbejder bruger 5 timer/uge på manuel indtastning ≈ 250 timer/år ≈ 60.000-90.000 kr/år i løn.
...
- **Omfang**: Én konkret dokumentproces (fx indgående fakturaer). Du bygger et fungerende flow: modtag → udtræk → validér → aflever i kundens system/regneark. Inkl. 2 ugers support efter levering.
- **Varighed**: 2-3 uger (ved 8-10 timer/uge — vær ærlig med dig selv om kalendertid).
...
## 6. Praktisk opstart i Danmark

> OBS: Tjek altid aktuelle regler på skat.dk og virk.dk — dette er et overblik, ikke rådgivning.

1. **Virksomhedsform**: Start som **enkeltmandsvirksomhed** (gratis, oprettes på virk.dk, CVR-nummer med det samme). ApS (40.000 kr kapital) er unødvendigt før du har væsentlig omsætning/risiko.
2. **Moms**: Momsregistrering er pligtig ved forventet omsætning over 50.000 kr/12 mdr. Registrér dig fra start — dine B2B-kunder forventer moms på fakturaen alligevel, og du kan trække købsmoms fra (software, udstyr).
3. **Skat ved siden af fuldtidsjob**: Overskuddet beskattes som personlig indkomst oveni din løn. Sæt ca. **40-50 % af overskuddet til side** til skat, og ret din forskudsopgørelse når indtægterne begynder.
4. **Bibeskæftigelse**: Tjek din ansættelseskontrakt for konkurrence-/bibeskæftigelsesklausuler, især hvis du senere tager kunder i nærheden af din arbejdsgivers felt.
5. **Regnskab**: Brug Dinero eller Billy fra dag 1 (gratis/billige niveauer findes). Bonus: du bliver selv bruger af de økonomisystemer, dine kunder sidder i.
